        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse " id="menu">
                ...
                <li class="nav-item active dropdown">
                        <a href="admin.php" class="nav-link dropdown-toggle" data-toggle="dropdown">Promotores <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                        <li class="navbar-nav mr-auto"><a href="../admin.php" class="nav-link">Registrar Promotores</a></li>
                        </ul>
                    </li>               
                    <li class="nav-item active dropdown">
                        ...
                        <li class="navbar-nav mr-auto "><a href="../buscador/index.php" class="nav-link">Registrar Asistencia</a></li>
                        <li class="navbar-nav mr-auto "><a href="asistentes.php" class="nav-link">Listar Asistencia</a></li>
                        </ul>
                    </li>
                </ul>
